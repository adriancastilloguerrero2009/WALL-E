...
import type { LifeCycleStore, MaybeArray, InputSchema, LifeCycleType, HookContainer, Replace, SchemaValidator, AnyLocalHook, SSEPayload, Prettify } from 'elysia/dist/types';
...
export declare const mergeResponse: (a: InputSchema["response"], b: InputSchema["response"]) => string | import("@sinclair/typebox").TSchema | import("elysia/dist/types").StandardSchemaV1Like<unknown, unknown> | {
    [x: number]: string | import("elysia/dist/types").AnySchema;
} | undefined;
